...
export default function ProfileButton() {
    ...
    return (
        <div className="relative">
            ...
            >
                <div className="w-9 h-9 rounded-full bg-black overflow-hidden border border-black/5 shadow-inner">
                    <img src="/apu_123_avatar.png" className="w-full h-full object-cover" alt="Profile" />
                </div>
                <div className="flex flex-col items-start leading-none pr-1">
                    <span className="text-[8px] font-black uppercase tracking-[0.2em] text-black/20 mb-0.5">Active</span>
                    <span className="text-[11px] font-black uppercase tracking-tight text-black/80">apu_123</span>
                </div>
            </button>
                    ...
                    <>
                        ...
                        >
                            <div className="flex flex-col items-center pt-8 pb-8 bg-gradient-to-b from-gray-50/50 to-transparent rounded-[2.2rem] mb-2">
                                <div className="w-24 h-24 rounded-[2.5rem] bg-white border border-black/5 p-1.5 shadow-xl mb-4 overflow-hidden">
                                    <img src="/apu_123_avatar.png" className="w-full h-full object-cover rounded-[1.8rem]" alt="Apu_123" />
                                </div>
                                <h2 className="text-xl font-black text-black uppercase tracking-tighter leading-none">apu_123</h2>
